...
using RTXLauncher.WinForms.Utilities;
	...
	public partial class Form1
	{
		...
		private async Task PopulateUpdateSourcesComboBox(bool userInitiated = false)
		{
			...
			try
			{
				...
				try
				{
					devDownload = await _githubService.FetchLatestStagingArtifact("Xenthio", "RTXLauncher", userInitiated);
				...
				var releases = await _githubService.FetchReleasesAsync("Xenthio", "RTXLauncher", userInitiated);
