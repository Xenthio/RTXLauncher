...
// A message that will be broadcast when the RTX install path changes
// so UI can refresh any cached install-location state.
public record InstallPathChangedMessage();
