namespace RTXLauncher
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			groupBox6.Controls.Add(gameMountCheckbox1);
			...
			groupBox6.Size = new Size(434, 246);
			...
			label22.Location = new Point(6, 225);
			label22.Name = "label22";
			label22.Size = new Size(354, 15);
			label22.TabIndex = 2;
			label22.Text = "Contact either Xenthio or CR on the RTX Remix Showcase Discord!";
			label22.Click += label21_Click;
			// 
			// label21
			// 
			label21.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
			label21.AutoSize = true;
			label21.Location = new Point(6, 210);
			label21.Name = "label21";
			label21.Size = new Size(395, 15);
			label21.TabIndex = 2;
			label21.Text = "Do you have an RTX remaster of a source game on Steam that isn't listed? \r\n";
